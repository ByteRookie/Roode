...
SETTING_NUMBER_DEFS = [
    ...
    (CONF_ENTRY_MAX_THRESHOLD,    "ENTRY_MAX_PCT",          1,  100,  1,   "mdi:arrow-collapse-up",     "set_entry_max_threshold_number"),
    (CONF_ENTRY_MIN_THRESHOLD,    "ENTRY_MIN_PCT",          0,   99,  1,   "mdi:arrow-collapse-down",   "set_entry_min_threshold_number"),
    (CONF_EXIT_MAX_THRESHOLD,     "EXIT_MAX_PCT",           1,  100,  1,   "mdi:arrow-collapse-up",     "set_exit_max_threshold_number"),
    (CONF_EXIT_MIN_THRESHOLD,     "EXIT_MIN_PCT",           0,   99,  1,   "mdi:arrow-collapse-down",   "set_exit_min_threshold_number"),
