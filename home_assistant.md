...
Roode has endpoints to set the count value, reset the counter to 0 and to recalibrate. Unfortunately it's not possible to expose buttons via ESPHome that do just that.
